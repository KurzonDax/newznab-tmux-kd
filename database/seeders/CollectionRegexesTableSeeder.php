    ...
    public function run(): void
    {
        ...
        DB::table('collection_regexes')->insert([
            ...
            112 => [
                'id' => 113,
                'group_regex' => '^alt\\.binaries\\.boneless$',
                'regex' => '/^\\[\\d+\\/\\d+\\] - "(?P<match0>.+?)(?:\\.mkv\\.part\\d+\\.rar|\\.(?:bin|mkv)(?:\\.vol\\d+\\+\\d+)?\\.par2|\\.tar\\.zst(?:\\.vol\\d+\\+\\d+\\.par2|\\.par2)?|([\-_](proof|sample|thumbs?))*(\\.part\\d*(\\.rar)?|\\.rar|\\.7z)?(?:\\d{1,3}\\.rev|\\.vol\\d+\\+\\d+\\.par2|\\.[A-Za-z0-9]{2,4})?)"[\-_\\s]{0,3}yEnc$/ui',
                'status' => 1,
