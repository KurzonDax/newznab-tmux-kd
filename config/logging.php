...
return [
    ...
    'channels' => [
        ...
        /*
         * Laravel Boost injects a `single`-driver `browser` channel of its own, but
         * only when this key is undefined (BoostServiceProvider::registerBrowserLogger()).
         * Defining it here overrides that with the rotating driver every other
         * channel uses, so browser.log cannot grow unbounded.
         */
        'browser' => [
            'driver' => 'daily',
