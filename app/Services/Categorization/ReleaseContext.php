...
{
    private const string STANDALONE_SEASON_TOKEN_REGEX = '/(?:^|[._ -])S\d{1,4}(?=$|[._ -])/i';

    private const string SEASON_EPISODE_TOKEN_REGEX = '/(?:^|[._ ()\[\]-])S\d{1,4}[._ -]?(?:E|D(?:isc)?)\d{1,4}(?:[._ -]?E\d{1,4})*(?=$|[._ ()\[\]-])/i';
