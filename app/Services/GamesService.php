...
class GamesService
{
    ...
    public function getGamesRange(mixed $page, mixed $cat, mixed $start, mixed $num, array|string $orderBy = '', string $maxAge = '', array $excludedCats = []): mixed
    {
        ...
        $releasesSql = 'SELECT ranked.id, ranked.gamesinfo_id, ranked.guid, ranked.searchname, ranked.display_name, '
            ...
            .'FROM ( '
            .'SELECT r.id, r.gamesinfo_id, r.guid, r.searchname, r.display_name, r.size, r.postdate, r.adddate, '
