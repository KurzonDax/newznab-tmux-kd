...
class ConsoleService
{
    ...
    public function getConsoleRange(int $page, array $cat, int $start, int $num, string $orderBy, array $excludedCats = []): mixed
    {
        ...
        $releasesSql = 'SELECT ranked.id, ranked.consoleinfo_id, ranked.guid, ranked.searchname, ranked.completion, ranked.repair_outcome, ranked.rescan_outcome, '
            ...
            .'FROM ( '
            .'SELECT r.id, r.consoleinfo_id, r.guid, r.searchname, r.completion, r.repair_outcome, r.rescan_outcome, r.size, r.postdate, r.adddate, '
