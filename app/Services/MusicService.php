...
class MusicService
{
    ...
    public function getMusicRange(int $page, array $cat, int $start, int $num, string $orderBy, array $excludedCats = []): mixed
    {
        ...
        $releasesSql = 'SELECT ranked.id, ranked.musicinfo_id, ranked.guid, ranked.searchname, ranked.display_name, '
            ...
            .'FROM ( '
            .'SELECT r.id, r.musicinfo_id, r.guid, r.searchname, r.display_name, r.size, r.postdate, r.adddate, '
