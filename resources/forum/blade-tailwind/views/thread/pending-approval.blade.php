        ...
        @else
                    ...
                    <div class="rounded-xl border border-gray-200 bg-(--surface-card) shadow-sm dark:border-gray-700 dark:bg-(--surface-card-dark)">
                        <div class="border-b border-gray-200 p-4 dark:border-gray-700">
                            <div class="flex items-start gap-4">
                                <div class="pt-1">
                                    <input type="checkbox" name="threads[]" :value="{{ $thread->id }}" v-model="selectedIds" class="thread-checkbox rounded border-gray-300 text-primary-600 shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 dark:border-gray-600 dark:bg-(--surface-panel-alt-dark) dark:text-primary-400 dark:focus:border-primary-400 dark:focus:ring-primary-400">
                                </div>
                                <div class="flex-1">
                                    <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                                        <div>
                                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                                                ...
                                                <a href="{{ Forum::route('thread.show', $thread) }}" class="text-primary-600 hover:underline dark:text-primary-400">
                                                    {{ $thread->title }}
                                                </a>
                                            </h3>
            ...
            <div class="mt-4 flex flex-wrap gap-4">
                ...
                <button type="button"
                        ...
                        class="rounded-md bg-primary-500 px-4 py-2 text-white shadow hover:bg-primary-600 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-primary-600 dark:hover:bg-primary-500">
