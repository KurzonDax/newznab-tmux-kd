...
@php
    $classes = [
        ...
        'primary' => 'bg-accent-surface text-accent-on hover:bg-primary-800 focus:ring-primary-500 dark:bg-accent-surface-dark dark:text-accent-on-dark dark:hover:bg-primary-400',
        'success' => 'bg-green-600 text-white hover:bg-green-700 focus:ring-green-500',
        'warning' => 'bg-yellow-600 text-white hover:bg-yellow-700 focus:ring-yellow-500',
    ][$tone] ?? 'bg-accent-surface text-accent-on hover:bg-primary-800 focus:ring-primary-500 dark:bg-accent-surface-dark dark:text-accent-on-dark dark:hover:bg-primary-400';
