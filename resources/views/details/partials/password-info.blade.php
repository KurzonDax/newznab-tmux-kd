            ...
            @if(isset($release->passwordstatus) && $release->passwordstatus > 0)
                <div class="detail-password-card bg-linear-to-r from-red-50 to-orange-50 dark:from-red-900 dark:to-orange-900 rounded-lg p-6 border border-red-100 dark:border-red-800">
                    ...
                    <div class="space-y-3">
                        <div>
                            <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Password Status</dt>
                            <dd class="mt-1">
                        ...
                        <div>
                            <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400 mb-2">Password</dt>
                            <dd class="mt-1">
                                @if(!empty($release->password))
                                    <div class="surface-panel rounded-lg p-3 border">
                                        <code class="text-[13px] text-gray-900 dark:text-gray-100 font-sans break-all">{{ $release->password }}</code>
                                    </div>
                                ...
                                @else
                                    <div class="surface-panel rounded-lg p-3 border">
                                        <code class="text-[13px] text-gray-500 dark:text-gray-400 font-sans">None</code>
                                    </div>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">
