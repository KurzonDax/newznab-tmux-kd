                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        @if(!empty($anidbEnglishTitle) || !empty($anidbOriginalTitle) || !empty($anidbRomajiTitle) || !empty($anidbHashtag))
                            <div class="md:col-span-2">
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400 mb-2">Titles</dt>
                                <dd class="mt-1 space-y-2">
                                    @if(!empty($anidbEnglishTitle))
                                        <div class="text-[13px] text-gray-900 dark:text-gray-100 font-semibold">
                                    ...
                                    @if(!empty($anidbHashtag))
                                        <div class="text-[13px] text-gray-900 dark:text-gray-100">
                                            <span class="text-xs text-gray-500 dark:text-gray-400 font-normal mr-2">Hashtag:</span>
                                            <span class="font-sans text-primary-600 dark:text-primary-400">{{ $anidbHashtag }}</span>
                                        </div>
                                    @endif
                        ...
                        @elseif(!empty($anidbTitle))
                            <div>
                                ...
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100 font-semibold">{{ $anidbTitle }}</dd>
                            </div>
                        @endif
                        @if(!empty($anidbMediaType))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Media Type</dt>
                        ...
                        @if(!empty($anidbType))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Format</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ ucfirst(str_replace('_', ' ', strtolower($anidbType))) }}</dd>
                            </div>
                        @endif
                        @if(!empty($countryName))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Country</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">
                        ...
                        @if(!empty($anidbStatus))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Status</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ $anidbStatusLabel }}</dd>
                            </div>
                        @endif
                        @if(!empty($anidbSource))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Source</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ $anidbSourceLabel }}</dd>
                            </div>
                        @endif
                        @if(!empty($anidbEpisodes))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Episodes</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ number_format($anidbEpisodes) }}</dd>
                            </div>
                        @endif
                        @if(!empty($anidbDuration))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Duration</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ $anidbDuration }} minutes</dd>
                            </div>
                        @endif
                        @if(!empty($anidbStartDate))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Start Date</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ $anidbStartDate }}</dd>
                            </div>
                        @endif
                        @if(!empty($anidbEndDate))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">End Date</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ $anidbEndDate }}</dd>
                            </div>
                        @endif
                        @if(!empty($anidbRating))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Rating</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">
                                    <span class="inline-flex items-center">
                        ...
                        @if(!empty($anidbCategories))
                            <div class="md:col-span-2">
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Genres</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ $anidbCategories }}</dd>
                            </div>
                        @endif
                        @if(!empty($anidbCreators))
                            <div class="md:col-span-2">
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Studios</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ $anidbCreators }}</dd>
                            </div>
                        @endif
                        @if(!empty($anidbDescription))
                            <div class="md:col-span-2">
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Description</dt>
                                <dd class="mt-1 text-[13px] text-gray-700 dark:text-gray-300">{{ $anidbDescription }}</dd>
                            </div>
                        @endif
                    </div>
