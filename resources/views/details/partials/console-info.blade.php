                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        @if(!empty($conTitle))
                            <div>
                                ...
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100 font-semibold">{{ $conTitle }}</dd>
                            </div>
                        @endif
                        @if(!empty($conPublisher))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Publisher</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ $conPublisher }}</dd>
                            </div>
                        @endif
                        @if(!empty($conReleaseDate))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Release Date</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ $conReleaseDate }}</dd>
                            </div>
                        @endif
                    </div>
                </div>
