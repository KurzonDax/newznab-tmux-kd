                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        @if(!empty($gameTitle))
                            <div>
                                ...
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100 font-semibold">{{ $gameTitle }}</dd>
                            </div>
                        @endif
                        @if(!empty($gamePublisher))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Publisher</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ $gamePublisher }}</dd>
                            </div>
                        @endif
                        @if(!empty($gameReleaseDate))
                            <div>
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Release Date</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ $gameReleaseDate }}</dd>
                            </div>
                        @endif
                        @if(!empty($gameGenres))
                            <div class="md:col-span-2">
                                <dt class="text-[11px] font-medium text-gray-600 dark:text-gray-400">Genres</dt>
                                <dd class="mt-1 text-[13px] text-gray-900 dark:text-gray-100">{{ $gameGenres }}</dd>
                            </div>
                        @endif
                    </div>
                </div>
