                ...
                <div class="flex items-start justify-between gap-4 mb-4">
                    <div class="min-w-0 flex-1">
                        <template x-if="hasReleaseName()">
                            <div>
                                <h3 class="line-clamp-2 wrap-break-word text-lg font-medium text-gray-900 dark:text-gray-100" id="preview-modal-title" x-text="releaseName" :title="releaseName"></h3>
                                <p class="text-xs text-gray-500 dark:text-gray-400" x-text="title"></p>
                            </div>
                        </template>
