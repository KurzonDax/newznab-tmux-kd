...
<button type="button"
        ...
        x-cloak
        @click="scrollToTop()"
        class="fixed z-40 bg-accent-surface text-accent-on dark:bg-accent-surface-dark dark:text-accent-on-dark p-3 rounded-full shadow-lg hover:bg-primary-800 dark:hover:bg-primary-400 transition-colors touch-target
