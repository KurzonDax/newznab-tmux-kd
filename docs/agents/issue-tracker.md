...
- **Read an issue**: `gh issue view <number> --json title,body,labels,comments` to read the body, labels, and comments together. `--comments` alone omits the issue body.
...
Run `gh issue view <number> --json title,body,labels,comments` and read both the body and comments.
